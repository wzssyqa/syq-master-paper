...
\def\makecover{
	...
	\vspace{2.34cm}
		...
		辽宁工程技术大学\\
         \vspace{0.24cm}
		\xiaosi\song
		Liaoning Technological University
	}
	\end{center}
	\cleardoublepage
	\end{titlepage}
...
% 独创性说明
\def\originality{
\chapter*{\hfill  学位论文原创性声明 \hfill}
\addcontentsline{toc}{chapter}{学位论文原创性声明}
\large{
本人声明所呈交的论文是我个人在导师的指导下进行的研究工作所取得的成果。%
尽我所知，除文中特别加以标注和致谢的地方外，%
论文中不包含其他人已经发表或撰写过的的研究成果。%%
其他同志对本研究所做的任何贡献均已在论文中做了明确的说明并表示了谢意。%
   \\
   \\
本人学位论文与资料若有不实，愿意承担一切的法律责任。
	
	　  学位论文作者签名：	\underline{\hspace{4.5cm}}
	
	　 \qquad \qquad\qquad\qquad\qquad 年\qquad 月\qquad 日 
}
}
...
{
\begin{center}
    \sanhao\hei~辽宁工程技术大学学位论文版权使用授权书~
\end{center}

\sihao\song\noindent
　　本人完全了解学校有关学位论文知识产权的规定，%
在校攻读学位期间论文工作的知识产权属于辽宁工程技术大学，允许论文被查阅和借阅。%
