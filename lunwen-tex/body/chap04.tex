...
\begin{figure}[!htbp]
   ...
   \bicaption[figure:xiaoguotu]{图}{厂区效果图}
...
\begin{figure}[!htbp]
   \centering
   \includegraphics[scale=0.17]{control-points.png}
   \bicaption[figure:control-points]{图}{控制点布设示意图}
...
和直接使用FastICA时一样，也将最初使用光学水准仪测量的数据去掉，
