...
纵轴正方向为装载量，负方向为各点沉降量。(\ref{figure:plot-41}, \ref{figure:plot-42})
\begin{figure}[!htbp]
   \centering
...
\begin{figure}[!htbp]
   ...
   \bicaption[figure:plot-41-ica-poped]
			{}{一号末煤仓使用FastICA后得到的四个独立分量及装载量、气温的图像(去除初期数据之后)}
...
\begin{figure}[!htbp]
   ...
   \bicaption[figure:plot-41-pca-poped]{一号末煤仓PCA降维后使用FastICA后得到的四个独立分量及装载量、气温的图像}
				    {一号末煤仓使用PCA降维FastICA后得到的四个独立分量及装载量、气温的图像}
			{Fig.}{Four IC(With PCA first), Loadage and Temperature for Powder Bulker No.1}
\end{figure}
